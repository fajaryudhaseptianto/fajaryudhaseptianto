...
trait TimeTrait
{
     ...
     *
     * Keeping compatibility with PHP 8.4's DateTimeImmutable::createFromTimestamp signature
     * while still accepting optional timezone and locale via additional arguments.
     *
     * @return self
     *
     * @throws Exception
    ...
    {
        $timezone = func_num_args() > 1 ? func_get_arg(1) : null;
        $locale   = func_num_args() > 2 ? func_get_arg(2) : null;
