                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width:18%">
                                        ...
                                        <form action="<?= site_url('akun2/' . $value->id_akun2) ?>" method="post" id="del-<?= $value->id_akun2 ?>" class="d-inline">
                                            ...
                                            <button class="btn btn-danger btn-small" data-confirm="Hapus Data....? | Apakah Anda Yakin....?" data-confirm-yes="hapus(<?= $value->id_akun2 ?>)"><i class="fas fa-trash"></i> Delete</button>
                                        </form>
                                    </td
                                        </tr>
